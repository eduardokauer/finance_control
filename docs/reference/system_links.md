...
## Objetivo
Registrar os links canônicos do projeto para referência, tracking e manutenção.

## Regra de uso
- Este arquivo é a fonte de verdade dos links do projeto.
- Mudou um link canônico? Atualizar aqui primeiro.
- Não usar este arquivo como contexto recorrente do executor técnico.
- Os links abaixo são referência; acesso automático depende dos conectores/apps estarem disponíveis e conectados.
