...
class CategorizationRule(Base):
    ...
    source_scope: Mapped[str] = mapped_column(String(30), nullable=False, default="both")
    is_active: Mapped[bool] = mapped_column(Boolean, default=True, nullable=False)
...
class CreditCardInvoiceItem(Base):
    ...
    categorization_method: Mapped[str | None] = mapped_column(String(40), nullable=True)
